...
// __CLOSE_PRINT__
//
//  SignatureCoolAmongProjectorTriangleView.m
...
//: @interface SignatureCoolAmongProjectorTriangleView ()
@interface SignatureCoolAmongProjectorTriangleView ()

//: @end
@end

//: @implementation SignatureCoolAmongProjectorTriangleView
@implementation SignatureCoolAmongProjectorTriangleView
...
- (void)setAccount:(UIColor *)triangleColor {
    //: _triangleColor = triangleColor;
    _account = triangleColor;
