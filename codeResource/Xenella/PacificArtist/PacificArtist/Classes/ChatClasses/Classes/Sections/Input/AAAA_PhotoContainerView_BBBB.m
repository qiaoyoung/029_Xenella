//
//  AAAA_PhotoContainerView_BBBB.m
//  Xenella
//
...
@interface AAAA_PhotoContainerView_BBBB ()<AAAA_CustomMediaPickerViewDelegate_BBBB,UIGestureRecognizerDelegate>
...
@implementation AAAA_PhotoContainerView_BBBB
...
- (void)initUI {
    ...
    // 创建相册选择器视图
    _albumPickerView = [[AAAA_CustomAlbumPickerView_BBBB alloc] initWithFrame:CGRectMake(20, 30, SCREEN_WIDTH-40, _minHeight-120)];
...
#pragma mark - AAAA_CustomAlbumPickerView_BBBBDelegate
