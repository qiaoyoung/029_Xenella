...
//: @protocol ChainStarReflect <NSObject>
@protocol ChainStarReflect <NSObject>
//: @optional
@optional

/**
 *  输入按钮类型，请填入 PassageAbundantBalancerBinary 枚举，按顺序排列。不实现则按默认排列。
 */
 ...
 */
//: - (NSArray<OptimizeStencilForcefulPaintClose *> *)mediaItems;
- (NSArray<OptimizeStencilForcefulPaintClose *> *)mediaLine;
