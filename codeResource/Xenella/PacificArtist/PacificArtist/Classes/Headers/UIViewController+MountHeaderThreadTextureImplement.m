...
- (void)setNavBarBackGroundColor:(UIColor *)color{
    [self.navigationController.navigationBar setBackgroundImage:[FixNavigateHandle getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:FixNavigateHandleDirectionLevel] forBarMetrics:UIBarMetricsDefault];
