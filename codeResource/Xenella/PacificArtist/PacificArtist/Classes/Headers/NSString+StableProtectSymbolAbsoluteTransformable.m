...
- (NSString *)flat {
    //: NSString * result = [self nim_localizedWithTable:[StableProtectSymbolAbsoluteTransformable sharedKit].languageTable];
    NSString * result = [self constituent:[StableProtectSymbolAbsoluteTransformable common].outpouringDateTitles];
    //: return result;
    return result;
}
...
- (NSString *)weaken:(NSBundle *)bundle praisePeriodicTable:(NSString *)table {
    //: if (!bundle) {
    if (!bundle) {
        //: return self;
        return self;
...
- (NSString *)constituent:(NSString *)table {
    //: NSBundle * languageBundle = [StableProtectSymbolAbsoluteTransformable sharedKit].languageBundle;
    NSBundle * languageBundle = [StableProtectSymbolAbsoluteTransformable common].postKit;
    //: return [self nim_localizedByBundle:languageBundle table:table];
    return [self weaken:languageBundle praisePeriodicTable:table];
}
