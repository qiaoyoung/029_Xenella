...
@property (nonatomic, assign) LocalizeOverlayImplement holdTurn;

//: @property (nonatomic, strong) KeeperElevateTemplate *atCache;
@property (nonatomic, strong) KeeperElevateTemplate *diamond;

//: @property (strong, nonatomic) UIView *emoticonContainer;
@property (strong, nonatomic) UIView *blueCan;
...
@property (nonatomic, strong) NIMSession *secret;

//: @property (nonatomic, assign) NSInteger maxTextLength;
@property (nonatomic, assign) NSInteger sum;

//: @property (strong, nonatomic) DepotPainterAmongSync *toolBar;
@property (strong, nonatomic) DepotPainterAmongSync *fade;
//: @property (strong, nonatomic) MildFormatThornInto *moreContainer;
@property (strong, nonatomic) MildFormatThornInto *portrait;
...
- (void)clueOfCompound:(NSArray *)contacts;
