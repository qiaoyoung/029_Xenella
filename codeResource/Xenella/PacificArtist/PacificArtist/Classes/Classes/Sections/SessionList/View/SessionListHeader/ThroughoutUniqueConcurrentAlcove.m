...
- (UIColor *)fillBackgroundColor:(ThroughoutUniqueConcurrentAlcoveType)type{
    NSDictionary *dict = @{
                           @(ThroughoutUniqueConcurrentAlcoveTypeNetStauts)    : UIColorFromRGB(0xFFE3E3),
                           @(ThroughoutUniqueConcurrentAlcoveTypeCommonText)   : UIColorFromRGB(0xff6347),
                           @(ThroughoutUniqueConcurrentAlcoveTypeLoginClients) : UIColorFromRGB(0xff6347)
                           };
    return dict[@(type)];
}
