...
//    [ShapeSurfTerminalSystematic show];
    ...
    [FertileSuiteEnableCacheLine uploadImagesWithURL:Server_other_feedback parameters:dict images:array imageNames:nameArray progress:^(NSProgress *progress) {
...
//        [ShapeSurfTerminalSystematic dismiss];
        [self.loadingView animationClose];
        [ShapeSurfTerminalSystematic showMessage:LangKey(@"group_info_activity_op_failed")];
    }];
...
- (UIImagePickerController *)imagePickerVc {
    if (_imagePickerVc == nil) {
        ...
        _imagePickerVc.navigationBar.barTintColor = [UIColor colorWithPatternImage:[FixNavigateHandle getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:FixNavigateHandleDirectionLevel]];
