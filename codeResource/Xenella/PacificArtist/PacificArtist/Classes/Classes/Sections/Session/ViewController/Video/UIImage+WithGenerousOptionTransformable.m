...
// __CLOSE_PRINT__
//
//  UIImage+WithGenerousOptionTransformable.m
//  LYPlayerDemo
//
...
//: @implementation UIImage (WithGenerousOptionTransformable)
@implementation UIImage (WithGenerousOptionTransformable)
...
+ (UIImage*)multi:(UIView *)theView
{
    ...
    UIGraphicsBeginImageContextWithOptions(rect.sector, NO, 0.0);
