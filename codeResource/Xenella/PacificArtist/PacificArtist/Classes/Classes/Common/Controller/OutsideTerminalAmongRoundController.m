...
//        NSString *title  = item[TabbarTitle];
    ...
    navBar.barTintColor = [UIColor colorWithPatternImage:[FixNavigateHandle getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:FixNavigateHandleDirectionVertical]];
    [navBar setTitleTextAttributes:dic];
    [navBar setShadowImage:[UIImage new]];
    [navBar setBackgroundImage:[FixNavigateHandle getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:FixNavigateHandleDirectionLevel] forBarMetrics:UIBarMetricsDefault];
    ...
    if (_configs == nil)
    {
        _configs = @{
                     @(OutsideTerminalAmongRoundTypeMessageList) : @{
                             TabbarVC           : @"TangibleRefreshBeneathCapture",
                     ...
                     @(OutsideTerminalAmongRoundTypeChatroomList): @{
                             TabbarVC           : @"LocalizeVoyageDualCancel",
                     ...
                     @(OutsideTerminalAmongRoundTypeContact)     : @{
                             TabbarVC           : @"SeasonalReliableLayer",
                     ...
                     @(OutsideTerminalAmongRoundTypeSetting)     : @{
                             TabbarVC           : @"CreekTowardMigrateView",
