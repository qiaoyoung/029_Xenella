...
// __CLOSE_PRINT__
//
//  UIAlertView+TempleEnableAlign.m
//  eim_iphone
//
...
static char coreDemandId;

//: @implementation UIAlertView (TempleEnableAlign)
@implementation UIAlertView (TempleEnableAlign)
//: - (void)alertView:(UIAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex
- (void)thinIndex:(UIAlertView *)alertView description:(NSInteger)buttonIndex
{
    //: AlertBlock block = objc_getAssociatedObject(self, &kUIAlertViewBlockAddress);
    AlertBlock block = objc_getAssociatedObject(self, &coreDemandId);
    //: if (block)
    if (block)
    {
        //: block(buttonIndex);
        ...
        objc_setAssociatedObject(self, &coreDemandId, nil, OBJC_ASSOCIATION_COPY);
    }
}


//: - (void)showAlertWithCompletionHandler: (void (^)(NSInteger))block
- (void)attachDecline: (void (^)(NSInteger))block
{
    //: self.delegate = self;
    self.delegate = self;
    //: objc_setAssociatedObject(self,&kUIAlertViewBlockAddress,block,OBJC_ASSOCIATION_COPY);
    objc_setAssociatedObject(self,&coreDemandId,block,OBJC_ASSOCIATION_COPY);
    //: [self show];
    [self show];
}
...
//: @implementation UIAlertController (TempleEnableAlign)
@implementation UIAlertController (TempleEnableAlign)
