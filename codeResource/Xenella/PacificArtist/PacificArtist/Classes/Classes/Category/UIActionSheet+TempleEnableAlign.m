...
// __CLOSE_PRINT__
//
//  UIActionSheet+TempleEnableAlign.m
//  eim_iphone
//
...
static char styleLabName;


//: @implementation UIActionSheet (TempleEnableAlign)
@implementation UIActionSheet (TempleEnableAlign)
...
- (void)briquet
{
    ...
    objc_setAssociatedObject(self,&styleLabName,nil,OBJC_ASSOCIATION_COPY);
}
...
- (void)actionSheet:(UIActionSheet *)actionSheet didDismissWithButtonIndex:(NSInteger)buttonIndex
{
    ...
    ActionSheetBlock block = [objc_getAssociatedObject(self, &styleLabName) copy];
    //: objc_setAssociatedObject(self,&kUIActionSheetBlockAddress,nil,OBJC_ASSOCIATION_COPY);
    objc_setAssociatedObject(self,&styleLabName,nil,OBJC_ASSOCIATION_COPY);
...
- (void)portrait: (UIView *)view resistance: (ActionSheetBlock)block
{
    ...
    objc_setAssociatedObject(self,&styleLabName,block,OBJC_ASSOCIATION_COPY);
    ...
    else
    {
        ...
        else
        {
            ...
            [self performSelector:@selector(demonstrates:)
                       //: withObject:view
                       withObject:view
                       //: afterDelay:1];
                       afterDelay:1];
