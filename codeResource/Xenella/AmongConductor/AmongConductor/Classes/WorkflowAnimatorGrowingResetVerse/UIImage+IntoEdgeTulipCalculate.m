...
// __CLOSE_PRINT__
//
//  UIImage+IntoEdgeTulipCalculate.m
//  LYPlayerDemo
//
...
//: @implementation UIImage (IntoEdgeTulipCalculate)
@implementation UIImage (IntoEdgeTulipCalculate)

//缩放到指定大小
//根据颜色和圆的半径来创建一个圆形图片
//: + (UIImage *)createImageWithColor:(UIColor *)color radius:(CGFloat)radius
+ (UIImage *)enable:(UIColor *)color evokeForceCorner:(CGFloat)radius
{
...
- (UIImage *)beforeFor:(UIImage*)image retention:(CGSize)size
{
...
+ (UIImage*)intervalroduce:(UIView *)theView
{
