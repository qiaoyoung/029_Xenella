...
{
    SmartWorkflowAnimatorIndex *emoticonCatalog = [[CelestialBreakScaffold sharedManager] emoticonCatalog:NEEKIT_EmojiCatalog];
    if (emoticonCatalog) {
...
{
    SmartWorkflowAnimatorIndex *emoticonCatalog = [[CelestialBreakScaffold sharedManager] emoticonCatalog:NEEKIT_EmojiGifCatalog];
    if (emoticonCatalog) {
        StarOffSuper *layout = [[StarOffSuper alloc] initEmojiLayout:self.device_width];
        emoticonCatalog.layout = layout;
        emoticonCatalog.pagesCount = [self numberOfPagesWithEmoticon:emoticonCatalog];
