...
// __CLOSE_PRINT__
//
//  DynamicScrollViewAcceptCoordinator.m
// TreatLayoutExotic
//
...
//: @interface DynamicScrollViewAcceptCoordinator ()
@interface DynamicScrollViewAcceptCoordinator ()
...
//: @implementation DynamicScrollViewAcceptCoordinator
@implementation DynamicScrollViewAcceptCoordinator
...
- (void)gen:(CGRect)rect page:(CGContextRef)context{
...
- (void)drawRect:(CGRect)rect
{
    ...
    if ([[self badgeValue] length]) {
        ...
        [self gen:rect page:context];
    //: }else{
    }else{
        //: [self drawWithOutContent:rect context:context];
        [self haveAGo:rect transfer:context];
    }
...
- (CGSize)canFor:(NSString *)badgeValue{
...
- (void)haveAGo:(CGRect)rect transfer:(CGContextRef)context{
    //: CGRect bodyFrame = self.bounds;
    CGRect bodyFrame = self.bounds;
...
- (CGRect)streetwise:(NSString *)badgeValue{
    //: CGSize badgeSize = [self badgeSizeWithStr:badgeValue];
    CGSize badgeSize = [self canFor:badgeValue];
...
+ (instancetype)borderTip:(NSString *)badgeValue{
    ...
    //: DynamicScrollViewAcceptCoordinator *instance = [[DynamicScrollViewAcceptCoordinator alloc] init];
    DynamicScrollViewAcceptCoordinator *instance = [[DynamicScrollViewAcceptCoordinator alloc] init];
    //: instance.frame = [instance frameWithStr:badgeValue];
    instance.frame = [instance streetwise:badgeValue];
...
- (void)setBadgeValue:(NSString *)badgeValue {
    ...
    self.frame = [self streetwise:badgeValue];
