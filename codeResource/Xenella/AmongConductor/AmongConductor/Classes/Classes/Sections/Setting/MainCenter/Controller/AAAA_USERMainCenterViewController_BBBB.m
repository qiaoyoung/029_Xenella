//
//  AAAA_USERMainCenterViewController_BBBB.m
//  NIM
//
...
#import "UIView+Layout.h"
#import "UIAlertView+AAAA_USERBlock_BBBB.h"
#import "AAAA_FFFUserInfoViewController_BBBB.h"//个人资料
#import "AAAA_USERUserQRCodeViewController_BBBB.h" //我的二维码
#import "AAAA_USERSafetySetingController_BBBB.h"   //安全设置
#import "AAAA_USERFeedbackViewController_BBBB.h" //意见反馈
...
@interface AAAA_USERMainCenterViewController_BBBB ()<NIMUserManagerDelegate>
...
@implementation AAAA_USERMainCenterViewController_BBBB
...
- (void)viewDidLoad {
    ...
    self.language = [self requestLanguage:[AAAA_MyUserDefaults_BBBB standardUserDefaults].language];
}
...
- (void)refreshUserInfo
{
    ...
    AAAA_FFFKitInfo_BBBB *info = [[AAAA_MyUserKit_BBBB sharedKit] infoByUser:userID option:nil];
    
    self.titleLabel.text = me.userInfo.nickName;
    self.accountLabel.text = [NSString stringWithFormat:@"%@",emptyString([AAAA_MyUserDefaults_BBBB standardUserDefaults].accountName)];
...
- (void)initUI{
    ...
    [qrBtn layoutButtonWithEdgeInsetsStyle:(AAAA_ImageTitleSpacing_BBBBEdgeInsetsStyleTop) imageTitleSpace:10];
...
-(void)userInfoCenter{
    AAAA_FFFUserInfoViewController_BBBB *vc = [[AAAA_FFFUserInfoViewController_BBBB alloc] init];
...
-(void)opinionBack{
    ...
    AAAA_USERFeedbackViewController_BBBB *vc = [[AAAA_USERFeedbackViewController_BBBB alloc] init];
    [self.navigationController pushViewController:vc animated:YES];
    
}
-(void)safetySeting{
    AAAA_USERSafetySetingController_BBBB *vc = [[AAAA_USERSafetySetingController_BBBB alloc] init];
    [self.navigationController pushViewController:vc animated:YES];
}

- (void)gotoMyLog
{
    AAAA_MyLogViewController_BBBB *vc = [[AAAA_MyLogViewController_BBBB alloc] init];
    [self.navigationController pushViewController:vc animated:YES];
}
...
-(void)changeLang
{
    AAAA_USERLanguageViewController_BBBB *vc = [[AAAA_USERLanguageViewController_BBBB alloc]init];
    [self.navigationController pushViewController:vc animated:YES];
}
-(void)exitApp{
