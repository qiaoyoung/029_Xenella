...
@interface AlertSpatialMeasure ()<UITextViewDelegate,TZImagePickerControllerDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
{
...
@property (strong, nonatomic) OverlayBindReleaseFlowLayout *layout;

@property (nonatomic,strong) UILabel *numLabel;
@property (nonatomic, strong) SpeakRelayNavigateEvent *loadingView;
@end

@implementation AlertSpatialMeasure
...
//    [CoordinateProperGridlinePushLanguage show];
    ...
    [TupleApplyCompute uploadImagesWithURL:Server_other_feedback parameters:dict images:array imageNames:nameArray progress:^(NSProgress *progress) {
...
//        [CoordinateProperGridlinePushLanguage dismiss];
        [self.loadingView animationClose];
        [CoordinateProperGridlinePushLanguage showMessage:LangKey(@"group_info_activity_op_failed")];
    }];

    return;
    
//    [TupleApplyCompute getWithUrl:Server_other_feedback params:dict isShow:YES success:^(id responseObject) {
//        NSDictionary *resultDict = (NSDictionary *)responseObject;
//        NSString *code = [resultDict newStringValueForKey:@"code"];
//        NSString *msg = [resultDict newStringValueForKey:@"msg"];
//        [CoordinateProperGridlinePushLanguage showMessage:msg];
...
- (UIImagePickerController *)imagePickerVc {
    if (_imagePickerVc == nil) {
        ...
        _imagePickerVc.navigationBar.barTintColor = [UIColor colorWithPatternImage:[AttachComputeClose getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:AttachComputeCloseDirectionLevel]];
...
- (void)configCollectionView {
    // 如不需要长按排序效果，将OverlayBindReleaseFlowLayout类改成UICollectionViewFlowLayout即可
    _layout = [[OverlayBindReleaseFlowLayout alloc] init];
...
//    _collectionView.backgroundColor = [UIColor colorWithRed:rgb green:rgb blue:rgb alpha:1.0];
    ...
    [_collectionView registerClass:[VisualizePreloadCoordinate class] forCellWithReuseIdentifier:@"VisualizePreloadCoordinate"];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    VisualizePreloadCoordinate *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"VisualizePreloadCoordinate" forIndexPath:indexPath];
...
#pragma mark - OverlayBindReleaseDataSource
