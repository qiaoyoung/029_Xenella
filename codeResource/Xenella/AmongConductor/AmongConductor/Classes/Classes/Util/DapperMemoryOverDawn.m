...
//: @implementation DapperMemoryOverDawn
@implementation DapperMemoryOverDawn
//: - (BOOL)shouldIgnoreMessage:(NIMMessage *)message
- (BOOL)shouldIgnoreMessage:(NIMMessage *)message
{
    //: NIMMessageType type = [FabricExpandedOptimizeResolver sharedConfig].ignoreMessageType;
    NIMMessageType type = [FabricExpandedOptimizeResolver shared].roleType;
...
- (BOOL)shouldIgnoreNotification:(NIMNotificationObject *)notification
{
    ...
    {
        //: NSArray *types = [[FabricExpandedOptimizeResolver sharedConfig] ignoreTeamNotificationTypes];
        NSArray *types = [[FabricExpandedOptimizeResolver shared] transfer];
