...
extern __attribute__((visibility ("default"))) NSString *const coreAccessValue(NSString *value);/** Touken前缀*/

extern __attribute__((visibility ("default"))) NSString *const featureVisitorRatioGreenValue(NSString *value);/** 加密密钥*/

extern __attribute__((visibility ("default"))) NSString *const themeLargeValueUtility(NSString *value);/** 即时聊天*/
