...
@property (assign, nonatomic) CoordinateProperGridlinePushLanguageStyle defaultStyle UI_APPEARANCE_SELECTOR;
...
@property (assign, nonatomic) CoordinateProperGridlinePushLanguageMaskType defaultMaskType UI_APPEARANCE_SELECTOR;
...
@property (assign, nonatomic) CoordinateProperGridlinePushLanguageAnimationType defaultAnimationType UI_APPEARANCE_SELECTOR;
