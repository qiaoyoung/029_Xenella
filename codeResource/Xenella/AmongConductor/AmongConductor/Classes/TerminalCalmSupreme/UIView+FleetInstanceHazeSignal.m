...
// __CLOSE_PRINT__
//
//  UIView+FleetInstanceHazeSignal.m
// TreatLayoutExotic
//
...
//: @implementation UIView (FleetInstanceHazeSignal)
@implementation UIView (FleetInstanceHazeSignal)

//: - (void)nim_showToast:(NSString *)message duration:(CGFloat)duration
- (void)ratioDestination:(NSString *)message exhibitOrDuration:(CGFloat)duration
{
