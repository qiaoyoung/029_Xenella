...
- (void)with:(void(^)(NSInteger index, NSArray *messages , NSError *error))handler;
...
- (void)duringTing:(NSArray *)indexPaths teamCapability:(BOOL)animated;

//: - (void)remove:(NSArray *)indexPaths;
- (void)began:(NSArray *)indexPaths;
...
- (void)setReam:(id<UITableViewDelegate, UITableViewDataSource>) tableDelegate;
