...
@interface ManifestEdgeMapRain : NSObject {
...
@implementation ManifestEdgeMapRain
- (id) init {
    self = [super init];
    if (self) {
...
- (NSString *)toXMLString {
    ...
    ManifestEdgeMapRain *stack = [[ManifestEdgeMapRain alloc] init];
    NSArray  *keys = nil;
    NSString *key  = nil;
    NSObject *value    = nil;
