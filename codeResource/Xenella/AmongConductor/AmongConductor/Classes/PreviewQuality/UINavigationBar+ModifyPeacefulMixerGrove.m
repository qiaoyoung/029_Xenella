...
// __CLOSE_PRINT__
//
//  UINavigationBar+ModifyPeacefulMixerGrove.m
//  NIM
//
...
//: @implementation UINavigationBar (ModifyPeacefulMixerGrove)
@implementation UINavigationBar (ModifyPeacefulMixerGrove)
...
+ (void)load{
    ...
    _dispatch_once(&onceToken, ^{
        ...
        swizzling_exchangeMethod([UINavigationBar class] ,@selector(layoutSubviews), @selector(immobiliseIf));
    //: });
    });
}
