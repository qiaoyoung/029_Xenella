...
@interface AAAA_CustomAlbumPickerView_BBBB () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, PHPhotoLibraryChangeObserver, UIImagePickerControllerDelegate, UINavigationControllerDelegate> 
...
@implementation AAAA_CustomAlbumPickerView_BBBB
...
- (void)setup {
    ...
    _mediaType = AAAA_MediaPickerMediaType_BBBBAll;
