//
//  AAAA_CCCContactsViewController_BBBB.m
//  NIM
//
...
@interface AAAA_CCCContactsViewController_BBBB ()<AAAA_USERUserListCell_BBBBDelegate,NIMUserManagerDelegate,NIMSystemNotificationManagerDelegate,
AAAA_USERContactUtilCell_BBBBDelegate,
AAAA_FFFContactDataCell_BBBBDelegate,
NIMLoginManagerDelegate,
NIMEventSubscribeManagerDelegate,
AAAA_USERContactSearch_BBBBDelegate> {
    UIRefreshControl *_refreshControl;
    AAAA_USERGroupedContacts_BBBB *_contacts;
}
...
@implementation AAAA_CCCContactsViewController_BBBB
...
-(void)getGroupData{
    ...
    [AAAA_HttpManager_BBBB getWithUrl:Server_group_searchall params:nil isShow:NO success:^(id responseObject) {
...
- (void)prepareData{
    _contacts = [[AAAA_USERGroupedContacts_BBBB alloc] init];
}
...
- (void)searchAction:(id)sender {
    AAAA_USERContactSearch_BBBBViewController *vc = [[AAAA_USERContactSearch_BBBBViewController alloc] init];
    vc.delegate = self;
    [self.navigationController pushViewController:vc animated:YES];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (_sliderIndex <= 0) {
        id<AAAA_USERContactItem_BBBB> contactItem = (id<AAAA_USERContactItem_BBBB>)[_contacts memberOfIndex:indexPath];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    AAAA_USERFriendListTableViewCell_BBBB *cell = [AAAA_USERFriendListTableViewCell_BBBB cellWithTableView:tableView];
    //        cell.delegate = self;
    if (_sliderIndex <= 0) {
...
#pragma mark - AAAA_USERUserListCell_BBBBDelegate
...
#pragma mark - AAAA_USERContactSearch_BBBBDelegate
...
#pragma mark - AAAA_FFFContactDataCell_BBBBDelegate
- (void)onPressAvatar:(NSString *)memberId{
    [self enterPersonalCard:memberId];
}

#pragma mark - AAAA_USERContactUtilCell_BBBBDelegate
...
-(void)friendNotification{
    AAAA_USERSystemNotificationViewController_BBBB *vc = [[AAAA_USERSystemNotificationViewController_BBBB alloc] init];
