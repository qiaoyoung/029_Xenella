//
//  AAAA_USERContactSearch_BBBBViewController.m
//  NIM
//
...
@interface AAAA_USERContactSearch_BBBBViewController ()<UISearchResultsUpdating, UISearchControllerDelegate>
...
@implementation AAAA_USERContactSearch_BBBBViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (tableView == self.tableView) {
        ...
        if (indexPath.section == 0) {
            ...
            AAAA_USERContactDataCell_BBBB * cell = [tableView dequeueReusableCellWithIdentifier:@"userList"];
            if (!cell) {
                cell = [[AAAA_USERContactDataCell_BBBB alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"userList"];
            }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tableView == self.tableView) {
        if (indexPath.section == 0) {
            ...
            AAAA_USERPersonalCardViewController_BBBB *vc = [[AAAA_USERPersonalCardViewController_BBBB alloc] initWithUserId:user.userId];
            [self showVC:vc];
