...
@interface AAAA_FFFUserInfoViewController_BBBB ()<NIMUserManagerDelegate,TZImagePickerControllerDelegate,AAAA_NSSetAvater_BBBBDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate>
...
@property (nonatomic, strong) AAAA_NSSetSexView_BBBB *sexView;
@property (nonatomic, strong) AAAA_UserSetNickNameView_BBBB *changeNickNameView;
@property (nonatomic, strong) AAAA_NSSetAvater_BBBB *aleartView;


@end

@implementation AAAA_FFFUserInfoViewController_BBBB
...
- (void)handleTheSign
{
    AAAA_USERSignSettingViewController_BBBB *vc = [[AAAA_USERSignSettingViewController_BBBB alloc] initWithNibName:nil bundle:nil];
...
- (void)remoteUpdateGender{
    ...
    [AAAA_HttpManager_BBBB getWithUrl:Server_user_editinfo params:dict isShow:YES success:^(id responseObject) {
...
- (void)uploadImage:(UIImage *)image{
    ...
    NSString *fileName = [AAAA_USERFileLocationHelper_BBBB genFilenameWithExt:@"jpg"];
    NSString *filePath = [[AAAA_USERFileLocationHelper_BBBB getAppDocumentPath] stringByAppendingPathComponent:fileName];
...
- (AAAA_UserSetNickNameView_BBBB *)changeNickNameView
{
    if(!_changeNickNameView){
        _changeNickNameView = [[AAAA_UserSetNickNameView_BBBB alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
//        _changeNickNameView.hidden = YES;
    }
    return _changeNickNameView;
}

- (AAAA_NSSetSexView_BBBB *)sexView
{
    if(!_sexView){
        _sexView = [[AAAA_NSSetSexView_BBBB alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
//        _sexView.hidden = YES;
    }
    return _sexView;
}
