//
//  AAAA_GetBackPasswordViewController_BBBB.m
//  Xenella
//
...
@interface AAAA_GetBackPasswordViewController_BBBB ()
...
@implementation AAAA_GetBackPasswordViewController_BBBB
...
-(void)commitButtonClick
{
    ...
    [AAAA_HttpManager_BBBB getWithUrl:Server_user_modifyPass params:dict isShow:YES success:^(id responseObject) {
