//
//  AAAA_RegisterInfoViewController_BBBB.m
//  Xenella
//
...
@interface AAAA_RegisterInfoViewController_BBBB ()
...
@implementation AAAA_RegisterInfoViewController_BBBB
...
- (void)nextButtonClick
{
    ...
    if (_headerImage) {
        ...
        [AAAA_SVProgressHUD_BBBB showMessage:LangKey(@"register_avtivity3_avatar")];
        return;
    }
...
//    [manager.registDict setObject:self.avaterUrl forKey:@"imageurl"];
    ...
    //注册
    [AAAA_USERRegistConfigManager_BBBB sendRegistRequest:self.navigationController];
}
