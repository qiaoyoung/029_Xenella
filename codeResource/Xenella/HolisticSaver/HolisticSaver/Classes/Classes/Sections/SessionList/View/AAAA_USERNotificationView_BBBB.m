//
//  AAAA_USERNotificationView_BBBB.m
//  NIM
//
...
@interface AAAA_USERNotificationView_BBBB ()<NIMSystemNotificationManagerDelegate,AAAA_NIMSystemNotificationCellDelegate_BBBB,UITableViewDelegate,UITableViewDataSource>

@property (nonatomic,assign)    BOOL shouldMarkAsRead;

@end

@implementation AAAA_USERNotificationView_BBBB
