...
@interface AAAA_USERBadgeView_BBBB ()
...
@implementation AAAA_USERBadgeView_BBBB

+ (instancetype)viewWithBadgeTip:(NSString *)badgeValue{
    if (!badgeValue) {
        badgeValue = @"";
    }
    AAAA_USERBadgeView_BBBB *instance = [[AAAA_USERBadgeView_BBBB alloc] init];
