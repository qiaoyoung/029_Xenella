...
@property (nonatomic, assign) NIMLoginClientType distance;

//: @property (nonatomic, assign) NSInteger totalInfoCount;
@property (nonatomic, assign) NSInteger areaFullInterval;

//: @property (nonatomic, copy) NSString *sdkVersion;
@property (nonatomic, copy) NSString *me;

//: @property (nonatomic, assign) NSInteger version;
@property (nonatomic, assign) NSInteger agreeReport;
...
+ (nullable instancetype)initWithConcept:(NSData *)data;
