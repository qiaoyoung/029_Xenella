...
@property (nonatomic,strong) CombinedControl *flip;
@property (nonatomic,strong) CombinedControl *receiveButton;
...
@interface CombinedControl : UIButton

//: @property (nonatomic,assign) EnumColorButtonCellStyle style;
@property (nonatomic,assign) EnumColorButtonCellStyle anti;
