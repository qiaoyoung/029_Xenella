...
@implementation YYAnimatedImageView (Reek)
...
+ (void)load {
    ...
    _dispatch_once(&onceToken, ^{
        ...
        method1 = class_getInstanceMethod([self class], @selector(addTable:));
