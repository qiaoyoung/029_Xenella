...
@implementation NSDictionary (Wave)

//: - (unsigned long long)nimkit_jsonUnsignedLongLong:(NSString *)key
- (unsigned long long)nimkitBindAllNight:(NSString *)key
{
...
- (NSArray *)nimkit: (NSString *)key
{
    //: NSArray *array = [self nimkit_jsonArray:key];
    NSArray *array = [self observeInform:key];
    //: BOOL invalid = NO;
    BOOL invalid = NO;
...
- (NSArray *)observeInform: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
...
- (NSDictionary *)nimkitFromBoard: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
...
- (double)pictureObtain: (NSString *)key{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
    if ([object isKindOfClass:[NSString class]] ||
...
- (long long)securityTiming: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
...
- (NSString *)outSaving: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]])
...
- (NSInteger)willBug: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
