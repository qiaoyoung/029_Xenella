...
@implementation YYAnimatedImageView (Wire)

//: - (void)lz_displayLayer:(CALayer *)layer {
- (void)bounced:(CALayer *)layer {
...
+ (void)load {
    ...
    _dispatch_once(&onceToken, ^{
        ...
        method1 = class_getInstanceMethod([self class], @selector(bounced:));
