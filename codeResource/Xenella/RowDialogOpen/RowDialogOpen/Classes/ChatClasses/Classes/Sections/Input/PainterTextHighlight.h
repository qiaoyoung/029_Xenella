...
@interface PainterTextHighlight : YYTextHighlight

//: @property (nonatomic, assign) BOOL needFollow; 
@property (nonatomic, assign) BOOL accessClean;
//: @property (nonatomic, assign) BOOL associate; 
@property (nonatomic, assign) BOOL ting;// 联想话题区分
//: @property (nonatomic, copy) NSString *link;
@property (nonatomic, copy) NSString *doinge;
//: @property (nonatomic, copy) NSString *textId;
@property (nonatomic, copy) NSString *ellipticId;
@property (nonatomic, assign) BOOL wish;//点击发布后自动关注@对象
//: @property (nonatomic, copy) NSString *text;
@property (nonatomic, copy) NSString *collection;
//: @property (nonatomic, assign) EnumTextHighlightType type;
@property (nonatomic, assign) EnumTextHighlightType address;
