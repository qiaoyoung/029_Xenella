...
@interface AgentCenter()<NIMMediaManagerDelegate>

//: @property (nonatomic,assign) NSInteger retryCount;
@property (nonatomic,assign) NSInteger portrait;

//: @end
@end

//: @implementation FFFKitAudioCenter
@implementation AgentCenter
...
+ (instancetype)orientation
{
    ...
    static AgentCenter *instance;
    //: static dispatch_once_t onceToken;
    static dispatch_once_t onceToken;
    //: _dispatch_once(&onceToken, ^{
    _dispatch_once(&onceToken, ^{
        //: instance = [[FFFKitAudioCenter alloc] init];
        instance = [[AgentCenter alloc] init];
    //: });
    });
    //: return instance;
    return instance;
