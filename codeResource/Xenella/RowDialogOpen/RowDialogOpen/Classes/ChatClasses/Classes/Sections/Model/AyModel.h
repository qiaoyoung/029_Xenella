...
@property (nonatomic,readonly) NSTimeInterval power;

@property (nonatomic) BOOL aggregationCompare;//显示被回复消息内容

//: @property (nonatomic,strong) NSMapTable *quickComments;
@property (nonatomic,strong) NSMapTable *soapBubble;

//: @property (nonatomic) BOOL shouldShowPinContent; 
@property (nonatomic) BOOL flipComponent;

//: @property (nonatomic) CGSize emoticonsContainerSize; 
@property (nonatomic) CGSize partiPris;//显示快捷表情回复内容

//: @property (nonatomic,strong) NIMMessage *parentMessage;
@property (nonatomic,strong) NIMMessage *begetterInscription;

//: @property (nonatomic, readonly) CGPoint nickNameMargin;
@property (nonatomic, readonly) CGPoint document;
//: @property (nonatomic) BOOL shouldShowReadLabel; 
@property (nonatomic) BOOL specimenMe;

/*** 快捷回复数据 ***/
//: @property (nonatomic) BOOL enableQuickComments; 
@property (nonatomic) BOOL totalroRemote;//显示快捷表情回复内容

//: @property (nonatomic, readonly) UIEdgeInsets bubbleViewInsets;
@property (nonatomic, readonly) UIEdgeInsets accessDestination;

//: @property (nonatomic, readonly) UIEdgeInsets replyBubbleViewInsets;
@property (nonatomic, readonly) UIEdgeInsets compound;




//: @property (nonatomic,strong) NIMMessage *message;
@property (nonatomic,strong) NIMMessage *jump;
@property (nonatomic) BOOL associateOned;//显示PIN标记

//: @property (nonatomic) BOOL focreShowNickName; 
@property (nonatomic) BOOL focre;//强制显示昵称

//: @property (nonatomic, readonly) UIEdgeInsets replyContentViewInsets;
@property (nonatomic, readonly) UIEdgeInsets agreement;

//: @property (nonatomic, readonly) BOOL shouldShowNickName;
@property (nonatomic, readonly) BOOL personal;

//: @property (nonatomic) BOOL focreShowAvatar; 
@property (nonatomic) BOOL history;//强制显示头像


//: @property (nonatomic) BOOL enableRepliedContent; 
@property (nonatomic) BOOL analogiseCount;

//: @property (nonatomic, readonly) UIEdgeInsets contentViewInsets;
@property (nonatomic, readonly) UIEdgeInsets depth;
/*** 该消息的父、子消息 ***/
//: @property (nonatomic) BOOL enableSubMessages;
@property (nonatomic) BOOL bring;

//: @property (nonatomic, readonly) CGPoint avatarMargin;
@property (nonatomic, readonly) CGPoint maltster;

//: @property (nonatomic, readonly) BOOL shouldShowLeft;
@property (nonatomic, readonly) BOOL via;

/*** 该消息回复的消息内容 ****/
//: @property (nonatomic,strong) NIMMessage *repliedMessage;
@property (nonatomic,strong) NIMMessage *confirm;
