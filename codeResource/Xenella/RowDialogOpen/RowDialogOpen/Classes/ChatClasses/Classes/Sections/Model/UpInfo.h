...
//: typedef NS_ENUM(NSInteger, MyUserTeamType){
typedef NS_ENUM(NSInteger, MyUserTeamType){
    //: MyUserTeamTypeNomal = 0,
    MyUserTeamTypeNomal = 0,
    //: MyUserTeamTypeSuper = 1,
    MyUserTeamTypeSuper = 1,
//: };
};

//: @interface FFFKitInfo : NSObject
@interface UpInfo : NSObject
/**
 *   id,如果是用户信息，为用户id；如果是群信息，为群id
 */
//: @property (nonatomic,copy) NSString *infoId;
@property (nonatomic,copy) NSString *freshman;
/**
 *  头像图片
 */
//: @property (nonatomic,strong) UIImage *avatarImage;
@property (nonatomic,strong) UIImage *impression;
...
@property (nonatomic,copy) NSString *bite;
