...
@interface ReferViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,NIMLoginManagerDelegate,NIMConversationManagerDelegate>
/**
 *  会话列表tableView
 */
@property (nonatomic,assign) BOOL resignIndex;

/**
 *  删除会话时是不是也同时删除服务器会话 (防止漫游)
 */
//: @property (nonatomic,assign) BOOL autoRemoveRemoteSession;
@property (nonatomic,assign) BOOL inherent;
@property (nonatomic,strong) NSMutableArray * no;

//: @property (nonatomic,strong) UITableView *tableView;
@property (nonatomic,strong) UITableView *sliceUp;
/**
 *  最近会话集合
 */
//: @property (nonatomic,strong) NSMutableArray * recentSessions;
@property (nonatomic,strong) NSMutableArray * lastTitle;
...
- (void)powerPath:(NIMRecentSession *)recent
             //: atIndexPath:(NSIndexPath *)indexPath;
             stream:(NSIndexPath *)indexPath;
/**
