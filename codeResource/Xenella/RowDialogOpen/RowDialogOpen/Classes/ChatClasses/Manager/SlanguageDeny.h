...
@interface SlanguageDeny : NSObject
//: @property (nonatomic,strong) NSMutableDictionary *langDict;
@property (nonatomic,strong) NSMutableDictionary *signal;
//: + (NSString *)getLocale;
+ (NSString *)resting;
//: + (NSString *)getTextWithKey:(NSString *)key;
+ (NSString *)fall:(NSString *)key;
//: + (FFFLanguageManager *)shareInstance;
+ (SlanguageDeny *)contextRes;

//: - (void)setLanguagre:(NSString *)langType;
- (void)setScheme:(NSString *)langType;
