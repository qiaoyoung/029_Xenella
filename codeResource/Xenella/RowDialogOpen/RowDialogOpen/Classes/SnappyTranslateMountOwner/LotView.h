...
@protocol SoleDelegate <NSObject>
...
@property (nonatomic, strong) PHCachingImageManager *map;
...
@property (nonatomic, weak) id<SoleDelegate> delegate;
//: @property (nonatomic, strong) NSMutableArray<PHAsset *> *selectedAssets;
@property (nonatomic, strong) NSMutableArray<PHAsset *> *to;
@property (nonatomic, strong) NSMutableArray<PHAsset *> *selectedAssets;
@property (nonatomic, strong) PHCachingImageManager *imageManager;
