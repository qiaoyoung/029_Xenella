...
@property (nonatomic, assign) CGFloat biteTransform;

//: @property (nonatomic, assign) CGFloat sd_x;
@property (nonatomic, assign) CGFloat quantityermeasure;
//: @property (nonatomic, assign) CGFloat sd_y;
@property (nonatomic, assign) CGFloat stretch;
