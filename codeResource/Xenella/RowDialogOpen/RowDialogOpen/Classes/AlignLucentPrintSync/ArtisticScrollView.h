...
@interface ArtisticScrollView : UITextView
...
@property (nonatomic, copy) NSArray *even;

//: @property (nonatomic, copy)void (^praiseSelectBlock)(NSInteger tag);
@property (nonatomic, copy)void (^record)(NSInteger tag);
//: @property (nonatomic, copy) NSArray *selectedAllRangeButtons;
@property (nonatomic, copy) NSArray *percentageElite;
