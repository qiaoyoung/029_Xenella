...
static char kFactEvent;


//: @implementation UIActionSheet (USERBlock)
@implementation UIActionSheet (SeldomClean)
...

{
    ...
    ActionSheetBlock block = [objc_getAssociatedObject(self, &kFactEvent) copy];
    //: objc_setAssociatedObject(self,&kUIActionSheetBlockAddress,nil,OBJC_ASSOCIATION_COPY);
    objc_setAssociatedObject(self,&kFactEvent,nil,OBJC_ASSOCIATION_COPY);
...
- (void)roundIndex: (UIView *)view openlyIn: (ActionSheetBlock)block
{
    ...
    objc_setAssociatedObject(self,&kFactEvent,block,OBJC_ASSOCIATION_COPY);
    ...
    else
    {
        ...
        else
        {
            ...
            [self performSelector:@selector(groundspeed:)
                       //: withObject:view
                       withObject:view
                       //: afterDelay:1];
                       afterDelay:1];
