...
//: @interface USERMigrateHeader : NSObject
@interface PreciseDose : NSObject

@property (nonatomic, assign) NIMLoginClientType pick;
...
@property (nonatomic, copy) NSString *stripMust;
...
@property (nonatomic, assign) NIMLoginClientType zoneTotaly;
//: @property (nonatomic, assign) NSInteger version;
@property (nonatomic, assign) NSInteger fadeCompare;
...
+ (nullable instancetype)initWithDisabled:(NSData *)data;
