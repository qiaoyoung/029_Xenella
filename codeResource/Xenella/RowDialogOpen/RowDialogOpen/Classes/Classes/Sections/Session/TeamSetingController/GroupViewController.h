...
@property (nonatomic, copy) SpeiceAvaterBackBlock m;
//群组管理
//: @property (nonatomic,strong) FFFTeamListDataManager *teamListManager;
@property (nonatomic,strong) PortionEvolve *disturbing;
//: @property (nonatomic,strong) NSString *groupName;
@property (nonatomic,strong) NSString *filter;
@property (nonatomic, copy) SpeiceAvaterBackBlock chockText;
