 ...
 *
 * 如果您在使用 PreciseHelper 的过程中出现bug或有更好的建议,还请及时以下列方式联系我,我会及
 * 时修复bug,解决问题.
 *
...
@interface PreciseHelper : NSObject
...
+ (__kindof NSURLSessionTask *)actual:(NSString *)URL
                        //: parameters:(id)parameters
...
+ (__kindof NSURLSessionTask *)compound:(NSString *)URL
                         //: parameters:(id)parameters
...
+ (void)setJam:(void(^)(WithSkullSession *sessionManager))sessionManager;
...
+ (__kindof NSURLSessionTask *)electGender:(NSString *)URL
                                        //: parameters:(id)parameters
...
+ (__kindof NSURLSessionTask *)immovable:(NSString *)URL
                                       //: parameters:(id)parameters
                                       shade:(id)parameters
                                             //: name:(NSString *)name
                                             resting:(NSString *)name
                                             //: data:(NSData *)data
                                             event:(NSData *)data
                                         //: fileName:(NSString *)fileName
                                         challenge:(NSString *)fileName
                                        //: imageType:(NSString *)imageType
                                        read:(NSString *)imageType
                                         //: progress:(YLHttpProgress)progress
                                         force:(YLHttpProgress)progress
                                          //: success:(YLHttpRequestSuccess)success
                                          jump:(YLHttpRequestSuccess)success
                                          //: failure:(YLHttpRequestFailed)failure;
                                          pressurize:(YLHttpRequestFailed)failure;
 ...
 */
//: + (__kindof NSURLSessionTask *)POST:(NSString *)URL
+ (__kindof NSURLSessionTask *)alliterate:(NSString *)URL
                         //: parameters:(id)parameters
 ...
 */
//: + (__kindof NSURLSessionTask *)GET:(NSString *)URL
+ (__kindof NSURLSessionTask *)description:(NSString *)URL
                        //: parameters:(id)parameters
