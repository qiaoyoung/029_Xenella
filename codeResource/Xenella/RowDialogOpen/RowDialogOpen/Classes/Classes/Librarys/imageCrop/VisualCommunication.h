...
@interface UIImage (VisualCommunication)
...
@interface VisualCommunication : UIView
...
@property (nonatomic, assign) NSTimeInterval part;
//: @property (nonatomic, assign) NSTimeInterval updateInterval;
@property (nonatomic, assign) NSTimeInterval translate;
//: @property (nonatomic, assign) NSUInteger iterations;
@property (nonatomic, assign) NSUInteger timeMagnitude;
//: @property (nonatomic, getter = isDynamic) BOOL dynamic;
@property (nonatomic, getter = isDynamic) BOOL transition;
//: @property (nonatomic, strong) UIColor *tintColor;
@property (nonatomic, strong) UIColor *tintColor;
//: @property (nonatomic, weak) UIView *underlyingView;
@property (nonatomic, weak) UIView *beforeView;
//: @property (nonatomic, assign) CGFloat blurRadius;
@property (nonatomic, assign) CGFloat radiusAlongside;
//: @property (nonatomic, getter = isBlurEnabled) BOOL blurEnabled;
@property (nonatomic, getter = isBlurEnabled) BOOL playerSwitchd;
