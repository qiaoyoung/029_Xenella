...
@property (nonatomic, assign) CGFloat cornerPresent;
/// 辅助扫描边角颜色，默认为：[UIColor greenColor]
//: @property (nonatomic, strong) UIColor *cornerColor;
@property (nonatomic, strong) UIColor *edit;

/// 辅助扫描框的颜色，默认为：[UIColor whiteColor]
//: @property (nonatomic, strong) UIColor *borderColor;
@property (nonatomic, strong) UIColor *element;

@property (nonatomic, assign) SGCornerLoaction relative;

@property (nonatomic, assign) CGFloat stop;

/// 辅助扫描框的宽度，默认为：0.2f
//: @property (nonatomic, assign) CGFloat borderWidth;
@property (nonatomic, assign) CGFloat effectFit;

@property (nonatomic, assign) CGFloat propFloat;
...
@property (nonatomic, assign) CGFloat coatCompare;
...
@property (nonatomic, assign) SGCornerLoaction exclusive;

/// 扫描线每次移动的步长，默认为：3.5f
//: @property (nonatomic, assign) CGFloat scanlineStep;
@property (nonatomic, assign) CGFloat distinguish;
/// 是否需要辅助扫描框，默认为：NO
//: @property (nonatomic, assign) BOOL isShowBorder;
@property (nonatomic, assign) BOOL worldWide;

/// CropConView 背景色，默认为：[[UIColor blackColor] colorWithAlphaComponent:0.5]
