...
@property (nonatomic, assign) SGCornerLoaction forget;
...
@property (nonatomic, strong) UIColor *jump;
/// 扫描线是否执行逆动画，默认为：NO
//: @property (nonatomic, assign) BOOL autoreverses;
@property (nonatomic, assign) BOOL detail;

/// RevDragView 背景色，默认为：[[UIColor blackColor] colorWithAlphaComponent:0.5]
//: @property (nonatomic, strong) UIColor *color;
@property (nonatomic, strong) UIColor *loop;
...
@property (nonatomic, assign) CGFloat velleity;

/// 辅助扫描框的颜色，默认为：[UIColor whiteColor]
//: @property (nonatomic, strong) UIColor *borderColor;
@property (nonatomic, strong) UIColor *above;
...
@property (nonatomic, assign) BOOL pace;
