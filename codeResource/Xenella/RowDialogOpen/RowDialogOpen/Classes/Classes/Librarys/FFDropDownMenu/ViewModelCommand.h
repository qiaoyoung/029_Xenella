...
@protocol AutomaticDelegate <NSObject>
 ...
 *
 *  @param menuModelsArray     drop-down menu models array. Array storage EskerBasedModel instances
 ...
 *     English description:
 *     -----------------------------------------------------------
 *     drop-down nemu cell's class name. Must be a subclass of EcumenicalView
 *              If want to use this framework's drop-down nemu cell, direct pass @"CapView"
...
@property (nonatomic, assign) CGFloat hiddenFloat;
...
@property (nonatomic, assign) CGFloat estimatedMargin;
...
@property (nonatomic, assign) CGFloat tableDHoteDrawingHeight;
...
@property (nonatomic, assign) CGFloat player;
...
@property (nonatomic, strong) UIColor *inheritanceColor;
...
@property (nonatomic, assign) CGSize forEachDoinge;
...
@property (nonatomic, assign) CGFloat countoNeed;
...
@property (nonatomic, assign) CGFloat untilSure;
///==================================================================
///                    创建下拉菜单方式2
...
@property (nonatomic, assign) UIColor *calculateClear;
 ...
 *     English description:
 *     -----------------------------------------------------------
 *     drop-down menu models array(Array storage EskerBasedModel instances or the EskerBasedModel's subclass instances )
 */
...
@property (nonatomic, assign) CGFloat channelClear;
...
@property (nonatomic, weak) id<AutomaticDelegate> wholeDrawses;
...
@property (nonatomic, assign) UIColor *clear;

@property (nonatomic, assign) FFDropDownMenuViewAnimateType menuForgetType;

@property (nonatomic, assign) CGFloat triangleVideoFloat;
...
@property (nonatomic, strong) UIColor *triangle;
...
@property (nonatomic, assign) CGSize instance;
...
@property (nonatomic, assign) BOOL freshman;
@property (nonatomic, assign) CGFloat basic;
...
@property (nonatomic, assign) FFDropDownMenuViewAnimateType odd;
