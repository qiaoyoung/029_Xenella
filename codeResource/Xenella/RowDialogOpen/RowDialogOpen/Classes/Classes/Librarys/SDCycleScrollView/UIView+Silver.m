...
@implementation UIView (Silver)

//: - (void)setSd_x:(CGFloat)sd_x
- (void)setBe:(CGFloat)sd_x
{
...
- (void)setIslamicCalendarMonth:(CGFloat)sd_height
{
    //: CGRect temp = self.frame;
    CGRect temp = self.frame;
...
- (void)setMoreFloat:(CGFloat)sd_y
{
    //: CGRect temp = self.frame;
    CGRect temp = self.frame;
    //: temp.origin.y = sd_y;
...
- (void)setChance:(CGFloat)sd_width
{
    //: CGRect temp = self.frame;
    CGRect temp = self.frame;
