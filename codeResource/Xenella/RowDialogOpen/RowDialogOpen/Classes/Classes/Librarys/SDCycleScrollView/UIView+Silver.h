...
@interface UIView (Silver)

//: @property (nonatomic, assign) CGFloat sd_y;
@property (nonatomic, assign) CGFloat moreFloat;
//: @property (nonatomic, assign) CGFloat sd_height;
@property (nonatomic, assign) CGFloat islamicCalendarMonth;

//: @property (nonatomic, assign) CGFloat sd_x;
@property (nonatomic, assign) CGFloat be;
//: @property (nonatomic, assign) CGFloat sd_width;
@property (nonatomic, assign) CGFloat chance;
