...
@implementation UIDevice (Nationalist)
...
+ (CGFloat)underHeight {
    ...
    return [UIDevice lowness] + [UIDevice pastThan];
}
...
+ (CGFloat)asideHeight {
    ...
    return [UIDevice lowness] + [UIDevice bottomFlag];
}
...
+ (CGFloat)lowness {
    ...
    if (statusBarHeight <= 0) {
        ...
        CGFloat topPadding = [UIDevice visible];
