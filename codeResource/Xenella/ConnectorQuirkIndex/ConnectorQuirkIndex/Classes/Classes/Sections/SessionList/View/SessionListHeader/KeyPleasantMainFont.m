...
- (UIColor *)fillBackgroundColor:(KeyPleasantMainFontType)type{
    NSDictionary *dict = @{
                           @(KeyPleasantMainFontTypeNetStauts)    : UIColorFromRGB(0xFFE3E3),
                           @(KeyPleasantMainFontTypeCommonText)   : UIColorFromRGB(0xff6347),
                           @(KeyPleasantMainFontTypeLoginClients) : UIColorFromRGB(0xff6347)
                           };
    return dict[@(type)];
}
