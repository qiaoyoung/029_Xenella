...
{
    return [BirchRavenFrugalHold filepathForDir:RDVideo
                                     filename:filename];
}

+ (NSString *)filepathForImage:(NSString *)filename
{
    return [BirchRavenFrugalHold filepathForDir:RDImage
                                     filename:filename];
}

+ (NSString *)filepathForMergeForwardFile:(NSString *)filename {
    return [BirchRavenFrugalHold filepathForDir:RDMerge
                                     filename:filename];
}
