 ...
 *
 * 如果您在使用 MeritHueTrend 的过程中出现bug或有更好的建议,还请及时以下列方式联系我,我会及
 * 时修复bug,解决问题.
 *
 ...
 * 内修改,再加上此封装在支持CocoaPods后,如果使用者pod update最新MeritHueTrend,那又要重新修改此
 * 封装内的相关参数.
 *
 ...
 * 了,大大降低了项目的后期维护难度
 *
 * 综上所述,最终还是将设置参数的接口暴露出来,如果通过CocoaPods方式使用MeritHueTrend,在设置项目网络
