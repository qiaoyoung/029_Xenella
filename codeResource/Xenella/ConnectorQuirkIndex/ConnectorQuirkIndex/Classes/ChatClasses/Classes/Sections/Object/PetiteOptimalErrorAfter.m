//
//  MigrateAssignManagerVisionDesert.m
// ParseByBreakPerform
//
...
@interface PetiteOptimalErrorAfter()
{
...
@property (nonatomic,weak)    id<RemoveCloseOutlineFill> delegate;

@end

@implementation PetiteOptimalErrorAfter
...
{
    ConnectorPersistFluentVisitor *cell = (ConnectorPersistFluentVisitor *)[self.tableView cellForRowAtIndexPath:indexPath];
    if (cell) {
        @try {
