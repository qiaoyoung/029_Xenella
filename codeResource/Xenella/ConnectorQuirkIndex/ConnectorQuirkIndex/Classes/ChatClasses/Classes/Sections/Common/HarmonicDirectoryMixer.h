...
//: @interface HarmonicDirectoryMixer : NSObject
@interface HarmonicDirectoryMixer : NSObject
...
@property (nonatomic,strong) NSArray *dataStorageMediumConvert;//kUTTypeMovie,kUTTypeImage,kUTTypeGIF
