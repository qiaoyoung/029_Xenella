...
- (UITableViewCell*)builidBlueButtonCell:(id<RunComposeDeliver>) bodyData{
    PathwayOrderPlaySegment * cell = [self.tableView dequeueReusableCellWithIdentifier:TableButtonCellReuseId];
    if (!cell) {
        cell = [[PathwayOrderPlaySegment alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:TableButtonCellReuseId];
    }
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
...
- (UITableViewCell*)builidTeamMemberCell:(id<RunComposeDeliver>) bodyData{
    DropAngularBegin * cell = [self.tableView dequeueReusableCellWithIdentifier:TableMemberCellReuseId];
    if (!cell) {
        cell = [[DropAngularBegin alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:TableMemberCellReuseId];
    }
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
