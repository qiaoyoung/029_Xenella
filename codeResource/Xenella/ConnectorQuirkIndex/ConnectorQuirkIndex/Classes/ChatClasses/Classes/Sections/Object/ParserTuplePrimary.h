...
- (void)distance:(void(^)(NSInteger index, NSArray *messages , NSError *error))handler;
...
- (void)surf:(NSIndexPath *)indexPath;

//: - (void)insert:(NSArray *)indexPaths animated:(BOOL)animated;
- (void)confirm:(NSArray *)indexPaths allow:(BOOL)animated;

//: - (void)remove:(NSArray *)indexPaths;
- (void)diamondRemove:(NSArray *)indexPaths;

//: - (BOOL)canInsertChatroomMessages;
- (BOOL)canulate;

//: - (void)calculateContent:(MysticSnowColorfulComposer *)model;
- (void)slope:(MysticSnowColorfulComposer *)model;
...
- (void)setTitleureInformationNearConverter:(id<SendSearchNearConverter>) interactor;

//: - (void)setTableDelegate:(id<UITableViewDelegate, UITableViewDataSource>) tableDelegate;
- (void)setSign:(id<UITableViewDelegate, UITableViewDataSource>) tableDelegate;
