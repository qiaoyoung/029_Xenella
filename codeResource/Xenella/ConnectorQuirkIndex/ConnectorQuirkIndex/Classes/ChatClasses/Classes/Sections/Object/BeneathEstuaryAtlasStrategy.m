...
//: @interface BeneathEstuaryAtlasStrategy()<NIMMediaManagerDelegate>
@interface BeneathEstuaryAtlasStrategy()<NIMMediaManagerDelegate>
...
//: @implementation BeneathEstuaryAtlasStrategy
@implementation BeneathEstuaryAtlasStrategy
...
- (void)necessary:(NIMMessage *)message
{
...
+ (instancetype)dot
{
    //: static BeneathEstuaryAtlasStrategy *instance;
    static BeneathEstuaryAtlasStrategy *instance;
    //: static dispatch_once_t onceToken;
    static dispatch_once_t onceToken;
    //: _dispatch_once(&onceToken, ^{
    _dispatch_once(&onceToken, ^{
        //: instance = [[BeneathEstuaryAtlasStrategy alloc] init];
        instance = [[BeneathEstuaryAtlasStrategy alloc] init];
    //: });
    });
    //: return instance;
