...
- (void)setNavBarBackGroundColor:(UIColor *)color{
    [self.navigationController.navigationBar setBackgroundImage:[BeforeDismissCompose getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:BeforeDismissComposeDirectionLevel] forBarMetrics:UIBarMetricsDefault];
