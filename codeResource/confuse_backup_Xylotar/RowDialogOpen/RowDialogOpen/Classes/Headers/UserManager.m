...
+(BOOL)isLogin
{
//    if ([MyUserDefaults standardUserDefaults].user_id.length>0) {
//        return YES;
//    }else{
//        return NO;
//    }
...
//    NSString *UserNo = emptyString([MyUserDefaults standardUserDefaults].mobile);
//    return UserNo;
//}
//
//+ (NSString *)getHeaderImageUrl{
//    NSString *headImageUrl = emptyString([MyUserDefaults standardUserDefaults].head_img);
//    return headImageUrl;
//}
//+ (NSString *)getNickName{
//    NSString *headImageUrl = emptyString([MyUserDefaults standardUserDefaults].user_nickname);
//    return headImageUrl;
//}
//
//+ (void)callSevicePhoneNumber{
//    NSMutableString * string = [[ NSMutableString alloc] initWithFormat: @"tel:%@", [MyUserDefaults standardUserDefaults].serverPhoneNumber];
//    [[ UIApplication sharedApplication] openURL:[ NSURL URLWithString:string]];
//}
//+ (NSString *)setPrefixURLWithURL:(NSString *)imageurl{
//    NSString *prefixStr = [MyUserDefaults standardUserDefaults].prefixURL;
//
...
//    NSString *prefixStr = [MyUserDefaults standardUserDefaults].prefixURL;
//    NSString *suffixStr = [MyUserDefaults standardUserDefaults].thumbURL;
...
//+ (NSString *)getApikey{
//    NSString *apikey = emptyString([MyUserDefaults standardUserDefaults].apikey);
//    return apikey;
//}
//
//+ (NSString *)getApisecret{
//    NSString *apisecret = emptyString([MyUserDefaults standardUserDefaults].apisecret);
//    return apisecret;
//}
...
//        return;
//    }
//    [MyUserDefaults standardUserDefaults].compId = [dict newStringValueForKey:@"compId"];
//    [MyUserDefaults standardUserDefaults].orgId = [dict newStringValueForKey:@"orgId"];
//    [MyUserDefaults standardUserDefaults].orgName = [dict newStringValueForKey:@"orgName"];
//
//
//    [MyUserDefaults standardUserDefaults].longitude = [[dict newStringValueForKey:@"longitude"] doubleValue];
//    [MyUserDefaults standardUserDefaults].latitude  = [[dict newStringValueForKey:@"latitude"] doubleValue];
//
//    [MyUserDefaults standardUserDefaults].company_latitude = [dict newStringValueForKey:@"latitude"];
//    [MyUserDefaults standardUserDefaults].company_longitude = [dict newStringValueForKey:@"longitude"];
//
//    [MyUserDefaults standardUserDefaults].province = [dict newStringValueForKey:@"province"];
//    [MyUserDefaults standardUserDefaults].city     = [dict newStringValueForKey:@"city"];
//    [MyUserDefaults standardUserDefaults].district   = [dict newStringValueForKey:@"county"];
//    [MyUserDefaults standardUserDefaults].address   = [dict newStringValueForKey:@"address"];
//
...
//            
//            [MyUserDefaults standardUserDefaults].myName = [data newStringValueForKey:@"realName"];
//            [MyUserDefaults standardUserDefaults].myHeadImg = [data newStringValueForKey:@"headImg"];
//            [MyUserDefaults standardUserDefaults].myPosition = [data newStringValueForKey:@"position"];
//            [MyUserDefaults standardUserDefaults].myCompanyName = [data newStringValueForKey:@"compName"];
//
//        }
