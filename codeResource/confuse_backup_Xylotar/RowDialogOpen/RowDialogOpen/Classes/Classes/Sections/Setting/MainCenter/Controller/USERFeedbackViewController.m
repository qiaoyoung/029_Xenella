...
//    [SVProgressHUD show];
    ...
    [HttpManager uploadImagesWithURL:Server_other_feedback parameters:dict images:array imageNames:nameArray progress:^(NSProgress *progress) {
...
//    [HttpManager getWithUrl:Server_other_feedback params:dict isShow:YES success:^(id responseObject) {
//        NSDictionary *resultDict = (NSDictionary *)responseObject;
//        NSString *code = [resultDict newStringValueForKey:@"code"];
//        NSString *msg = [resultDict newStringValueForKey:@"msg"];
//        [SVProgressHUD showMessage:msg];
