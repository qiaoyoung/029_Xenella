...
- (void)remoteUpdateGender{
    ...
    [HttpManager getWithUrl:Server_user_editinfo params:dict isShow:YES success:^(id responseObject) {
...
- (UserSetNickNameView *)changeNickNameView
{
    if(!_changeNickNameView){
        _changeNickNameView = [[UserSetNickNameView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
