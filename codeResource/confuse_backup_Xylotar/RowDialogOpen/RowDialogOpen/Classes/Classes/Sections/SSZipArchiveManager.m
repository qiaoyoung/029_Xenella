...
- (NSString *)calculateAppResPath {
    ...
    NSString *resDir = [docuPath stringByAppendingPathComponent:kRowDialogOpen];
    ...
    NSString *fileResDir = [[docuPath stringByAppendingPathComponent:@"file"] stringByAppendingPathComponent:kRowDialogOpen];
    ...
    NSString *path = [[MyUserKit sharedKit].emoticonBundle pathForResource:kRowDialogOpen ofType:@".zip"];
    if (!path) {
