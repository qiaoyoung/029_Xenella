...
#define kMainTabbarManagerVersionKey @"kMainTabbarManagerVersionKey"
...
- (NSString *)calculateAppResPath {
    ...
    NSString *resDir = [docuPath stringByAppendingPathComponent:kPacificArtist];
    ...
    NSString *fileResDir = [[docuPath stringByAppendingPathComponent:@"file"] stringByAppendingPathComponent:kPacificArtist];
    ...
    NSString *path = [[StableProtectSymbolAbsoluteTransformable sharedKit].emoticonBundle pathForResource:kPacificArtist ofType:@".zip"];
    if (!path) {
