...
@property (assign, nonatomic) ShapeSurfTerminalSystematicStyle defaultStyle UI_APPEARANCE_SELECTOR;

/// Represents the type of mask applied when the HUD is displayed.
/// @discussion Default: ShapeSurfTerminalSystematicMaskTypeNone.
@property (assign, nonatomic) ShapeSurfTerminalSystematicMaskType defaultMaskType UI_APPEARANCE_SELECTOR;

/// Defines the animation type used when the HUD is displayed.
/// @discussion Default: ShapeSurfTerminalSystematicAnimationTypeFlat.
@property (assign, nonatomic) ShapeSurfTerminalSystematicAnimationType defaultAnimationType UI_APPEARANCE_SELECTOR;
