...
- (UITableViewCell*)builidBlueButtonCell:(id<HelperHelperBonnyBuilder>) bodyData{
    RichEntryCompress * cell = [self.tableView dequeueReusableCellWithIdentifier:TableButtonCellReuseId];
    if (!cell) {
        cell = [[RichEntryCompress alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:TableButtonCellReuseId];
    }
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
...
- (UITableViewCell*)builidTeamMemberCell:(id<HelperHelperBonnyBuilder>) bodyData{
    IntoViaVast * cell = [self.tableView dequeueReusableCellWithIdentifier:TableMemberCellReuseId];
    if (!cell) {
        cell = [[IntoViaVast alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:TableMemberCellReuseId];
    }
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
