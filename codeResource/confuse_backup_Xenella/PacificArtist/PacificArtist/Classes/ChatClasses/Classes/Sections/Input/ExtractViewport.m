...
{
    DeltaFallbackVerifyPage *emoticonCatalog = [[IndexGlacierWeightless sharedManager] emoticonCatalog:NEEKIT_EmojiCatalog];
    if (emoticonCatalog) {
...
{
    DeltaFallbackVerifyPage *emoticonCatalog = [[IndexGlacierWeightless sharedManager] emoticonCatalog:NEEKIT_EmojiGifCatalog];
    if (emoticonCatalog) {
        ConnectGentleCoordinatorVolume *layout = [[ConnectGentleCoordinatorVolume alloc] initEmojiLayout:self.device_width];
        emoticonCatalog.layout = layout;
        emoticonCatalog.pagesCount = [self numberOfPagesWithEmoticon:emoticonCatalog];
