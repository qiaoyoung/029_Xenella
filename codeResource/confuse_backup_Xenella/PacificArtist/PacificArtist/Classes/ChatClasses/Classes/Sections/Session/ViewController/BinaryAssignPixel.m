...
{
    if(!_customAlbumView){
        _customAlbumView = [[SymmetricStoreUntil alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
...
{
    if(!_audioContent){
        _audioContent = [[ReceiveSplitFileCandid alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
