...
{
    BuilderRecordTamePlay *emoticonCatalog = [[PlushFeasibleValidator sharedManager] emoticonCatalog:NEEKIT_EmojiCatalog];
    if (emoticonCatalog) {
...
{
    BuilderRecordTamePlay *emoticonCatalog = [[PlushFeasibleValidator sharedManager] emoticonCatalog:NEEKIT_EmojiGifCatalog];
    if (emoticonCatalog) {
        LedgerApplyElementGradient *layout = [[LedgerApplyElementGradient alloc] initEmojiLayout:self.device_width];
        emoticonCatalog.layout = layout;
        emoticonCatalog.pagesCount = [self numberOfPagesWithEmoticon:emoticonCatalog];
