...
@property (assign, nonatomic) ResizeNucleusDocumentRowStyle defaultStyle UI_APPEARANCE_SELECTOR;

/// Represents the type of mask applied when the HUD is displayed.
/// @discussion Default: ResizeNucleusDocumentRowMaskTypeNone.
@property (assign, nonatomic) ResizeNucleusDocumentRowMaskType defaultMaskType UI_APPEARANCE_SELECTOR;

/// Defines the animation type used when the HUD is displayed.
/// @discussion Default: ResizeNucleusDocumentRowAnimationTypeFlat.
@property (assign, nonatomic) ResizeNucleusDocumentRowAnimationType defaultAnimationType UI_APPEARANCE_SELECTOR;
