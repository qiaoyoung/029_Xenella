...
//    [ResizeNucleusDocumentRow show];
    ...
    [LocalizeHelixAccept uploadImagesWithURL:Server_other_feedback parameters:dict images:array imageNames:nameArray progress:^(NSProgress *progress) {
...
//        [ResizeNucleusDocumentRow dismiss];
        [self.loadingView animationClose];
        [ResizeNucleusDocumentRow showMessage:LangKey(@"group_info_activity_op_failed")];
    }];
...
- (UIImagePickerController *)imagePickerVc {
    if (_imagePickerVc == nil) {
        ...
        _imagePickerVc.navigationBar.barTintColor = [UIColor colorWithPatternImage:[BeforeDismissCompose getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:BeforeDismissComposeDirectionLevel]];
