...
//    [self setUpNav];
    ...
    [LocalizeHelixAccept getWithUrl:Server_user_detail params:dict isShow:NO success:^(id responseObject) {
...
//    [ResizeNucleusDocumentRow show];
    ...
    [LocalizeHelixAccept getWithUrl:Server_group_getgroups params:nil isShow:NO success:^(id responseObject) {
...
-(void)setingGroup{
    ...
    [LocalizeHelixAccept getWithUrl:Server_group_addgroupuser params:dict isShow:YES success:^(id responseObject) {
        NSDictionary *resultDict = (NSDictionary *)responseObject;
...
- (RotateOnImplementGridLocator *)changeRemarksView
{
    if(!_changeRemarksView){
        _changeRemarksView = [[RotateOnImplementGridLocator alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
...
{
    if(!_reprotView){
        _reprotView  = [[SoundUpUserView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
