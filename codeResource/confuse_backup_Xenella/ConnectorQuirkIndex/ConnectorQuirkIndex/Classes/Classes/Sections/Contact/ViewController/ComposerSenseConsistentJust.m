...
-(void)getGroupData{
    ...
    [LocalizeHelixAccept getWithUrl:Server_group_searchall params:nil isShow:NO success:^(id responseObject) {
...
-(void)newGroupSyncRequest:(NSString *)groupName teamID:(NSString *)teamId{
    ...
    dict[@"name"] = groupName;
    dict[@"id"] = teamId;
    [LocalizeHelixAccept getWithUrl:Server_team_create params:dict isShow:NO success:^(id responseObject) {
...
{
    if(!_loadingView){
        _loadingView = [[CoreSymbol alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
