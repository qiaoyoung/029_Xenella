...
#define kReceiveAgainstRemoveOrganizerManagerVersionKey @"kReceiveAgainstRemoveOrganizerManagerVersionKey"
...
- (NSString *)calculateAppResPath {
    ...
    NSString *resDir = [docuPath stringByAppendingPathComponent:kConnectorQuirkIndex];
    ...
    NSString *fileResDir = [[docuPath stringByAppendingPathComponent:@"file"] stringByAppendingPathComponent:kConnectorQuirkIndex];
    ...
    NSString *path = [[ParseByBreakPerform sharedKit].emoticonBundle pathForResource:kConnectorQuirkIndex ofType:@".zip"];
    if (!path) {
