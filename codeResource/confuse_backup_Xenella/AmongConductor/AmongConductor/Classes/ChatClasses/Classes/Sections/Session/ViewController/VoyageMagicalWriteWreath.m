...
{
    if(!_customAlbumView){
        _customAlbumView = [[SandTensePoolSweet alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
...
{
    if(!_audioContent){
        _audioContent = [[ByOutlineCompareStencil alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
