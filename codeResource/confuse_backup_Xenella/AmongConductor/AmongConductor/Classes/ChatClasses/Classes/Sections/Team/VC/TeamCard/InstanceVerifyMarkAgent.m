...
- (UITableViewCell*)builidBlueButtonCell:(id<ReferenceAgainst>) bodyData{
    LivelySortShuffle * cell = [self.tableView dequeueReusableCellWithIdentifier:TableButtonCellReuseId];
    if (!cell) {
        cell = [[LivelySortShuffle alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:TableButtonCellReuseId];
    }
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
...
- (UITableViewCell*)builidTeamMemberCell:(id<ReferenceAgainst>) bodyData{
    AgainstFormatTransformableGreenSleek * cell = [self.tableView dequeueReusableCellWithIdentifier:TableMemberCellReuseId];
    if (!cell) {
        cell = [[AgainstFormatTransformableGreenSleek alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:TableMemberCellReuseId];
    }
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
