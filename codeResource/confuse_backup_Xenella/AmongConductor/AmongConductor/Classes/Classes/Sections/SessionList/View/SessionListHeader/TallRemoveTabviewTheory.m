...
- (UIColor *)fillBackgroundColor:(TallRemoveTabviewTheoryType)type{
    NSDictionary *dict = @{
                           @(TallRemoveTabviewTheoryTypeNetStauts)    : UIColorFromRGB(0xFFE3E3),
                           @(TallRemoveTabviewTheoryTypeCommonText)   : UIColorFromRGB(0xff6347),
                           @(TallRemoveTabviewTheoryTypeLoginClients) : UIColorFromRGB(0xff6347)
                           };
    return dict[@(type)];
}
