...
#define kMaskRoundTransformerOrchardManagerVersionKey @"kMaskRoundTransformerOrchardManagerVersionKey"
...
- (NSString *)calculateAppResPath {
    ...
    NSString *resDir = [docuPath stringByAppendingPathComponent:kAmongConductor];
    ...
    NSString *fileResDir = [[docuPath stringByAppendingPathComponent:@"file"] stringByAppendingPathComponent:kAmongConductor];
    ...
    NSString *path = [[TreatLayoutExotic sharedKit].emoticonBundle pathForResource:kAmongConductor ofType:@".zip"];
    if (!path) {
