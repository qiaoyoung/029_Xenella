...
//: @implementation NSString (ParseByBreakPerform)
@implementation NSString (ParseByBreakPerform)
...
- (NSString *)correct:(NSBundle *)bundle without:(NSString *)table {
    //: if (!bundle) {
    if (!bundle) {
        //: return self;
        return self;
...
- (NSString *)infoControl {
    //: NSString * result = [self nim_localizedWithTable:[ParseByBreakPerform sharedKit].languageTable];
    NSString * result = [self belief:[ParseByBreakPerform unit].perception];
    //: return result;
    return result;
}
...
- (NSString *)belief:(NSString *)table {
    //: NSBundle * languageBundle = [ParseByBreakPerform sharedKit].languageBundle;
    NSBundle * languageBundle = [ParseByBreakPerform unit].pitchingChange;
    //: return [self nim_localizedByBundle:languageBundle table:table];
    return [self correct:languageBundle without:table];
}
