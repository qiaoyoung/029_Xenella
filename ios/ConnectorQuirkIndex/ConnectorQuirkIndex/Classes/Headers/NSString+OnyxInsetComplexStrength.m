...
// __CLOSE_PRINT__
//
//  NSString+OnyxInsetComplexStrength.m
//  NIMDemo
//
...
NSString * loopHalf(NSString *anMaybeEmptyString) {
...
//: @implementation NSString (OnyxInsetComplexStrength)
@implementation NSString (OnyxInsetComplexStrength)
...
+ (NSString *)exist:(NSUInteger)length {
    //: if (length == 0) {
    if (length == 0) {
        //: return @"";
        return @"";
