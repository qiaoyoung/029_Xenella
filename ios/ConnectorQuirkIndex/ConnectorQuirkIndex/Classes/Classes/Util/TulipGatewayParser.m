...
//: @implementation TulipGatewayParser
@implementation TulipGatewayParser
...
- (BOOL)shouldIgnoreNotification:(NIMNotificationObject *)notification
{
    ...
    {
        //: NSArray *types = [[PayloadParserResume sharedConfig] ignoreTeamNotificationTypes];
        NSArray *types = [[PayloadParserResume transfer] across];
...
- (BOOL)shouldIgnoreMessage:(NIMMessage *)message
{
    //: NIMMessageType type = [PayloadParserResume sharedConfig].ignoreMessageType;
    NIMMessageType type = [PayloadParserResume transfer].beliefEnable;
