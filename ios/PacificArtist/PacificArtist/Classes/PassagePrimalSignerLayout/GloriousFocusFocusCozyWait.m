...
//: @interface GloriousFocusFocusCozyWait()
@interface GloriousFocusFocusCozyWait()
...
//: @implementation GloriousFocusFocusCozyWait
@implementation GloriousFocusFocusCozyWait

//: - (void)textDidChangeNotification:(NSNotification *)notification
- (void)kindling:(NSNotification *)notification
{
...
- (instancetype)initWithFrame:(CGRect)frame textContainer:(NSTextContainer *)textContainer
{
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(kindling:) name:UITextViewTextDidChangeNotification object:self];
    }
    //: return self;
    return self;
}
...
- (void)drawRect:(CGRect)rect
{
    ...
    NSAttributedString *attributedString = self.instance;
...
- (void)setInstance:(NSAttributedString *)placeholderAttributedText
{
    //: _placeholderAttributedText = placeholderAttributedText;
    _instance = placeholderAttributedText;
    //: [self setNeedsDisplay];
    [self setNeedsDisplay];
}
