...
//: @implementation DecodeAssembler
@implementation DecodeAssembler
//: - (BOOL)shouldIgnoreMessage:(NIMMessage *)message
- (BOOL)shouldIgnoreMessage:(NIMMessage *)message
{
    //: NIMMessageType type = [BehindYieldGenericAdaptive sharedConfig].ignoreMessageType;
    NIMMessageType type = [BehindYieldGenericAdaptive pieceOfLand].variation;
...
- (BOOL)shouldIgnoreNotification:(NIMNotificationObject *)notification
{
    ...
    {
        //: NSArray *types = [[BehindYieldGenericAdaptive sharedConfig] ignoreTeamNotificationTypes];
        NSArray *types = [[BehindYieldGenericAdaptive pieceOfLand] north];
