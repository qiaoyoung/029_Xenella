...
@protocol UnderDelegate <NSObject>
...
- (void)body:(PullView *)cycleScrollView factorIndex:(NSInteger)index;

/** 图片滚动回调 */
//: - (void)cycleScrollView:(SDCycleScrollView *)cycleScrollView didScrollToIndex:(NSInteger)index;
- (void)gender:(PullView *)cycleScrollView last:(NSInteger)index;
...
@property (nonatomic, strong) UIImage *shared;
//: @property (nonatomic, assign) BOOL showGradient;
@property (nonatomic, assign) BOOL duringInside;

/** 占位图，用于网络未加载到图片时 */
//: @property (nonatomic, strong) UIImage *placeholderImage;
@property (nonatomic, strong) UIImage *powerContent;

//: @property (nonatomic, weak) id<SDCycleScrollViewDelegate> delegate;
@property (nonatomic, weak) id<UnderDelegate> delegate;
...
+ (instancetype)coordinator:(CGRect)frame phaseUponBioticCommunity:(NSArray *)imageURLStringsGroup;
