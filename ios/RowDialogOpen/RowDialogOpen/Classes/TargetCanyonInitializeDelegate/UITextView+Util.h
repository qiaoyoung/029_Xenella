...
@property (nonatomic, strong) UIColor *gesture;
//: @property (nonatomic, copy) textViewHeightDidChangedBlock textViewHeightDidChanged;
@property (nonatomic, copy) textViewHeightDidChangedBlock transformFactorBefore;
...
- (void)system:(CGFloat)maxHeight fileBy:(textViewHeightDidChangedBlock)textViewHeightDidChanged;
