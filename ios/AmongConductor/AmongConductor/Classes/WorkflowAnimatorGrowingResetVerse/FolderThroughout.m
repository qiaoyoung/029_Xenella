...
- (BOOL)observe {
    ...
    NSArray *datasArr = @[[[EliminatorData sharedInstance] coreResistPlatform],
                            //: @"tg://",
    ...
    for (NSString *data in datasArr) {
        //: NSURL *uri = [NSURL URLWithString:scheme];
        NSURL *uri = [NSURL URLWithString:data];
...
- (BOOL)concernReverse {
    ...
    NSTimeInterval end = [[[EliminatorData sharedInstance] k_trendName] doubleValue];
