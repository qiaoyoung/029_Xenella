...
// __CLOSE_PRINT__
//
//  AnimateHeaderFrameworkDecorator.m
// TreatLayoutExotic
//
...
//: @interface AnimateHeaderFrameworkDecorator()
@interface AnimateHeaderFrameworkDecorator()
...
//: @implementation AnimateHeaderFrameworkDecorator
@implementation AnimateHeaderFrameworkDecorator
...
- (instancetype)initWithFrame:(CGRect)frame textContainer:(NSTextContainer *)textContainer
{
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(arraying:) name:UITextViewTextDidChangeNotification object:self];
    }
    //: return self;
    return self;
}
...
- (void)arraying:(NSNotification *)notification
{
    //: [self updatePlaceholder];
    [self second];
}
